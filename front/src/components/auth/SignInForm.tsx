...
export default function SignInForm() {
  ...
  const handleGoogleSignIn = () => {
    // abre a rota do backend para login com Google
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              {/* Remover o Permacer logado*/}
              <Checkbox checked={isChecked} onChange={setIsChecked} />
              <span className="text-gray-700 dark:text-gray-400 text-theme-sm">
                Permanecer logado
              </span>
            </div>
            <Link
          ...
          <button
            type="submit"
            className="w-full px-4 py-3 text-sm font-medium text-white bg-brand-500 rounded-lg shadow-theme-xs hover:bg-brand-600 flex justify-center"
          >
            Sign in
          </button>
        </form>
