...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.nome || !formData.email || !formData.password || !isChecked) {
    ...
    try {
      const res = await fetch(API_ROUTES.AUTH.SIGNUP, {
        ...
        body: JSON.stringify({ nome: formData.nome, email: formData.email, senha: formData.password }),
      });
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={formData.nome} // ADICIONADO: Value controlado
                    onChange={handleChange} // ADICIONADO: Evento de mudança
                  />
                </div>
                {/* <!-- Email --> */}
                <div>
