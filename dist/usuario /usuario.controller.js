...
let UsuarioController = class UsuarioController {
    ...
    async criaUsuario(dadosDoUsuario) {
        ...
        return {
            usuario: new ListaUsuario_dto_1.ListaUsuarioDTO(usuario.id, usuario.name, usuario.company, usuario.role, usuario.status, usuario.verified, usuario.tipoUsuario),
